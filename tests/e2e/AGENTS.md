...
- `cockpit.spec.ts` covers the canonical payment scenario, immediate projection updates, source switching, draft reload, Stand Up validation, Axe, and mobile overflow.
